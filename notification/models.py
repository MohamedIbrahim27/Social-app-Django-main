...
class Notification(models.Model):
    ...
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notify_from_user',null=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notify_to_user',null=True)
    notification_type = models.IntegerField(choices=NOTIFICATION_TYPES,null=True)
    text_preview = models.CharField(max_length=120, blank=True,null=True)
